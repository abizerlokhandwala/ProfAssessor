class HomeController < ApplicationController
  ...
  def after_test
    ...
    # puts send_data.to_json
    result = (`python3 lib/assets/lol.py #{puts send_data.to_json}`)
    redirect_to '/dashboard'
  end
  ...
  def teacher
    ...
    # data = [{"label": "A", "count": 20},{"label": "B", "count": 5},{"label": "C", "count": 15},{"label": "D", "count": 15},{"label": "E", "count": 15}]
